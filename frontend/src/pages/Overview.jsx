...
export default function Overview({ analytics, onSelectCase, onSeedData, onOpenCopilot, loading }) {
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400">AI-powered revenue protection & recovery platform.</p>
        </div>
        
        <div className="flex items-center space-x-3">
          <button
            onClick={onOpenCopilot}
            className="flex items-center space-x-2 bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white font-bold px-4 py-2 rounded-lg text-sm transition-all shadow-lg shadow-sky-500/25"
          >
          ...
          <button
            onClick={onSeedData}
            disabled={loading}
            className="flex items-center space-x-2 bg-slate-800 hover:bg-slate-700 text-slate-200 font-medium px-4 py-2 rounded-lg text-sm transition-all"
          >
